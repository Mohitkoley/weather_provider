...
class Weather {
  ...
  factory Weather.fromJson(Map<String, dynamic> json) => Weather(
        id: json["id"],
        main: mainValues.map[json["main"]] == null
            ? null
            : mainValues.map[json["main"]],
        description: descriptionValues.map[json["description"]] ?? null,
        icon: json["icon"],
      );
...
enum Description { brokenClouds, clearSky, fewClouds, haze, scatteredClouds }
...
enum Main { clear, clouds, haze }

final mainValues =
    EnumValues({"Clear": Main.clear, "Clouds": Main.clouds, "Haze": Main.haze});
